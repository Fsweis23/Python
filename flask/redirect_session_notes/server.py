from flask import Flask, render_template, request, redirect, session #Import Flash to allow us to create our app
...
@app.route('/')     # The "@" decorator associates this route with the function immediatly following
def render_form():
    return render_template("index.html")  # Return the string 'Hellow World!' as a response
